...
<body>
  ...
  <div class="container" style="background-color:#3EAFAF;">
    ...
    <div class="col-md-9 col-sm-6 col-xs-12">
      <h3>Shop Dash</h3>
      <button type="button" id="editbtn" class="btn btn-default pull-right" title="Edit below details"><span class="glyphicon glyphicon-pencil"></span>
      </button> 
      <table>
        <tr>
         <td><span>Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </span></td>
<!--         <td><a href="#" id="name" class="a" data-type="text" data-placement="right" data-title="Enter username">Rahul Madakatti</a></td>-->
       		<td><div id="name1"><label id="name" class="labelfont">Rahul Madakatti</label></div></td>
       </tr>
       <tr>
...
<!--        <td><a href="#" id="address" class="a" data-type="textarea" data-rows="2" data-placement="right" data-title="Enter address">Tulsi Aangan Near Ganesh Ghat</a></td>-->
        <td><div id="address1"><label id="address" class="labelfont">Tulsi Aangan Near Ganesh Ghat</label></div></td>
      </tr>
      <tr>
        <td><span>State&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </span></td>
<!--        <td><a href="#" id="state" class="a" data-type="text" data-placement="right" data-title="Enter state">Maharashtra</a></td>-->
        <td><div id="state1"><label id="state" class="labelfont">Maharashtra</label></div></td>
      </tr>
      <tr>
        <td><span>City&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </span></td>
<!--        <td><a href="#" id="city" class="a" data-type="text" data-placement="right" data-title="Enter city">Thane</a></td>-->
        <td><div id="city1"><label id="city" class="labelfont">Thane</label></div></td>
      </tr>
      <tr>
        <td><span>Pin Code &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </span></td>
<!--        <td><a href="#" id="pin" class="a" data-type="text" data-placement="right" data-title="Enter pin">421503</a></td>-->
        <td><div id="pincode1"><label id="pincode" class="labelfont">421503</label></div></td>
      </tr>	        
    </table>	
    <!-- end of table -->
  </br>
  <span>Ratings:*****</span>
  <span class="pull-right">Social Connect:<button type="button" class="btn btn-default"><span class="glyphicon glyphicon-thumbs-up"></span>  facebook</span></button>
</div>
  ...
  <div class="row">
   <div class="col-md-2" style="margin-top: 20px;">
    <div class="list-group side-bar">
     <a href="profile1.jsp" class="list-group-item active"><span class="glyphicon glyphicon-home"></span> Dash</a>
