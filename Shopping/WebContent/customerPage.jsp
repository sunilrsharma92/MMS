...
<body>
	<div class="">
		...
		<form>
			<table>
				<tr><td>First Name:</td><td><input id="custFirstName1" type="text" class="textbox" value=""></td></tr>
				...
				<tr><td></td><td><button type="button" id="saveProfile" class="btn btn-primary" onclick="saveCustomerDetails()">Save Changes</button></td></tr>
			</table>
		</form>
	</div>
</body>
