...
<%
	final String user = "support@makemyshopy.com";
	...
	// 2nd step)compose message
		...
		message.addRecipient(Message.RecipientType.TO, new InternetAddress("madakattirahul@gmail.com"));

			link = "http://localhost:8080/shopping1/indexTemplate.jsp?otp";
			msg = "Please click the link above and note down this OTP  during Registration";
