...
<body>
    ...
    <div class="container ">
      ...
      <ul class="list-inline">
        ...
        <li class=""><a href="#"id="login" data-toggle="modal" data-target="#trackModal" class="whiteLabelLink"><span class="glyphicon glyphicon-map-marker"style="
            margin-right: 5px;"></span>Track <span class="hidden-xs">your order</span></a></li>
        <!-- Modal -->
          ...
          <div class="modal-dialog modal-sm">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body" style="text-align:center;">
                <input class="font textbox" type="text" placeholder="Enter the email or order id"/>
        ...
        <li class="pull-right">
         <a href="#" class="whiteLabelLink"><span class="glyphicon glyphicon-home" style="margin-right: 5px;" ></span>Home</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          <a href="#" data-toggle="modal" data-target="#LoginModal" id="login" class="whiteLabelLink"><span class="glyphicon glyphicon-user"style="
                  ...
                  <div class="modal-body">
                    ...
                    <div class="tab-content">
                      <div id="home" class="tab-pane fade in active">
                        ...
                        <input class="textbox font" type="text" id="emailLogin" placeholder="Email Id"></br>
                        <input class="textbox font" type="password"  id="passLoginTemp" placeholder="Password"></br>
...
<!-- 						</br> -->
    ...
    <div class="container-fluid mid-bar ">
      ...
      <div class="col-md-4 col-sm-4 col-xs-3">
        ...
        <span class="hidden-xs">CART</span> <span class="badge" ><label id="productCountOnCart" style="margin : auto;">0</label></span></button>
...
<!--               <span class="rups"><strong> Rs 0</strong> </span> -->
            ...
            <div class="totaldiv">
              <button class="btn btn-primary" id="checkout" type="button">Check Out</button>  <button class="btn btn-primary" type="button">Continue Shopping</button>
            </div>
          </div>       
        </div>      
      </div>
