...
//            alert("handleRequest     handleCategoryRequest     strjsonMsgForstrmainCategory : "+strjsonMsgForstrmainCategory);
...
////            alert("handleRequest     handleSubCategoryRequest     strjsonMsgForstrsubCategory : "+strjsonMsgForstrsubCategory);
...
//             alert("handleRequest     handleCategoryRequest     strjsonMsgForstrShopProfile : "+strjsonMsgForShopProfile);
  ...
  // -- customer/shopKeeper login verification
     ...
     function handleSignUp( passSignUp, mobileKey, emailKey, userType) 
     {
		try
		{
			...
			console.log("handleRequest     handleSignUp     strJsonMsgForSignUp : "+strJsonMsgForSignUp);
     ...
     /*function handleUsernameAvailCust(usernameSignUp)
     {
  	   try
 		{
  	   var  checkUsernameAvailCust = {};
  	   checkUsernameAvailCust.usernameSignUp = usernameSignUp;
  	   checkUsernameAvailCust.command = 1053;
			
			var strJsonMsgForCustUsernameAvail = JSON.stringify(checkUsernameAvailCust);
			console.log("handleRequest     handleUsernameAvailCust     strJsonMsgForCustUsernameAvail : "+strJsonMsgForCustUsernameAvail);
			
			handleAllListResponse(strJsonMsgForCustUsernameAvail);
 		}
  	   catch(e)
  	   {
...
//               alert("handleRequest     handleCategoryRequest     strjsonMsgForstrSelectedProduct : "+strjsonMsgForSelectedProduct);
//    		   console.log("handleRequest     handledisplaySelectedProduct     strjsonMsgForstrSelectedProduct : "+strjsonMsgForSelectedProduct);
...
////               alert("handleRequest     handledisplayProductinCart : "+strjsonMsgForstrProductinCart);
